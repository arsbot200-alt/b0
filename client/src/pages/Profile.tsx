...
import { MapPin, Calendar, Users, TrendingUp, Award, Copy, Share2, Edit, Shield, HelpCircle, Clock, Sparkles, Trophy, Target } from 'lucide-react';
        ...
        <div className="space-y-6 px-4">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm">
              <a
                href="https://x.com/PingCaset"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-slate-700 p-2 -m-2 rounded-lg transition-colors"
                data-testid="link-x"
              >
                <div className="flex items-center justify-center rounded-lg bg-black/10 dark:bg-white/10 w-10 h-10 shrink-0">
                  <SiX className="w-5 h-5 text-black dark:text-white" />
                </div>
                <div className="flex-1">
                  <p className="text-base font-bold text-gray-900 dark:text-gray-100">Follow us on X</p>
