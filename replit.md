...
**Game Economy Updates (Latest)**
- ✅ Referral rewards rebalanced: Inviter receives 25 coins, invited user receives 50 coins (down from 200/400)
- ✅ Spin wheel rewards updated: 10 (70%), 20 (20%), 50 (7%), 100 (2%), 500 (1%), Unlucky (0%)
- ✅ Spin wheel cost: 5 coins + 15 energy per spin
- ✅ Spin wheel UI enhanced with better text styling and positioning
- ✅ Scratch card rewards updated: 5 (70%), 10 (20%), 30 (10%) - max 100 coins
- ✅ Scratch card cost: 10 coins per card
- ✅ Scratch card made fully interactive with canvas-based scratching
- ✅ Achievement rewards adjusted: Daily Login (3 coins), Invite 10 Friends (50 coins), Play 50 Games (100 coins)
- ✅ Social media updated: Twitter changed to X with functional link to https://x.com/PingCaset
- ✅ All economy changes verified across backend and frontend, including Team earnings calculations
- ✅ TypeScript types updated for referral code queries
